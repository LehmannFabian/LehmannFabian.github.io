  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['jmontoyaz/hslu_weakly_segmentation_lehmann_2025', 'LehmannFabian/belka_prediction_challenge','LehmannFabian/TFT_recommender','aveliyath/i2c'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
      ...
      projects: [
        ...
        },
        {
          ...
          description:
            'This is a website for the woolstore Wollino of my mother. I built and now maintain the website',
          imageUrl:
            'https://wollino.ch/images/i1.jpg',
          link: 'https://wollino.ch/',      
